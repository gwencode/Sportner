class Event < ApplicationRecord
  ...
  def call_weather_event_api
    url = "https://api.worldweatheronline.com/premium/v1/weather.ashx?key=85ca93f406684910b42131430220512&q=#{self.spot.latitude},#{self.spot.longitude}&format=json&num_of_days=1&date=#{self.date.year}-#{self.date.month}-#{self.date.day}&includelocation=yes&tp=6&lang=fr"
